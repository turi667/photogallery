...
$result = $mysqli->query("SELECT * FROM album WHERE published=1");
?>
<h1>Published Albums From Other Users</h1>
<div class="row">
      ...
      <div class="col-sm-4 col-md-4">
        <div class="thumbnail">
          ...
          <div class="caption">
            ...
            <p><a href="viewpublished.php?album_id=<?php echo $row['id']; ?>" class="btn btn-primary" role="button">View</a> </p>
